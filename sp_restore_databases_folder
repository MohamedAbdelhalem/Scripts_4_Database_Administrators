USE [master]
GO
/****** Object:  StoredProcedure [dbo].[sp_restore_databases_folder]    Script Date: 7/1/2021 11:40:07 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE Procedure [dbo].[sp_restore_databases_folder]
(@backup_folder varchar(300), @restore_folder varchar(1000))
as
begin
...
exec [dbo].[sp_restore_database] 
@backupfile = @full_backup_file_name, 
@restore_loc = @restore_folder, 
@percent = 1 
