CREATE OR ALTER Procedure [dbo].[sp_restore_database_distribution_groups]
(
...
else if (@option_03 = 1 or @option_04 = 1)
begin
...
--select @files_exist, @files_exist_data, @files_exist_log
...
for
select 
LogicalName, [location], [filename], ext, type
from @filelistonly_groups
order by fileid
...
if @password = 'default' and @option_01 = 1
begin
set @sql = '
RESTORE '+
...
else if @password = 'default' and @option_02 = 1
begin
...
else if @password = 'default' and @option_04 = 1
begin
